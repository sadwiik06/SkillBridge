...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-black text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200",
        destructive: "bg-red-500 text-white hover:bg-red-600",
        cool: "dark:inset-shadow-2xs dark:inset-shadow-white/10 bg-linear-to-t border border-b-2 border-zinc-950/40 from-indigo-500 to-indigo-600 shadow-md shadow-indigo-500/20 ring-1 ring-inset ring-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 dark:border-x-0 text-white dark:border-t-0 dark:border-indigo-400 dark:ring-white/5",
...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-105 duration-300 transition text-zinc-900 dark:text-zinc-50",
...
const colorVariants = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-indigo-500 via-indigo-600 to-indigo-700",
    button: "bg-gradient-to-b from-indigo-500 to-indigo-600",
    textColor: "text-white",
...
const metalButtonVariants = (
  ...
  return {
    ...
    buttonStyle: {
      transform: isPressed ? "translateY(2px) scale(0.97)" : "translateY(0) scale(1)",
      transition: transitionStyle,
      transformOrigin: "center center",
      filter:
